---
title: "![](images/TAM-PrimaryMarkA.png){width=75%}"
...
```{r CourseInfo, results = 'asis', eval = T}
...
```{r LeaderInfo, results = 'asis', eval = T}
...
```{r ScheduleNonHtml, results = 'asis', eval = T}
...
```{r ScheduleHtml, results = 'asis', eval = F}
